...
public class TridiagonalMatrixTest {
    ...
    public void createMatrixFromFile(){
        // Test the creation of a TridiagonalMatrix from a file
        // Given a file containing coefficients for a tridiagonal matrix
        TridiagonalMatrix matrix = new TridiagonalMatrix(new File("src/test/resources/testMatrix.txt"));

        // When creating a TridiagonalMatrix instance from the file
        // Then assert that the coefficients are correctly read and stored
